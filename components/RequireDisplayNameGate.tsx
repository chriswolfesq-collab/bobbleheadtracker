    ...
    <>
      ...
      {needsDisplayName ? (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 px-4">
          <div className="w-full max-w-sm rounded-2xl border border-black/10 bg-white p-6 shadow-2xl shadow-black/50">
            <h2 className="text-lg font-black text-zinc-900">Choose a username</h2>
            ...
            >
              ...
              <button
                type="button"
                onClick={() => signOut()}
                className="text-center text-xs font-bold uppercase tracking-wide text-zinc-500 hover:text-zinc-700"
              >
                Cancel and log out
              </button>
            </form>
