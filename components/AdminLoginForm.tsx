...
export function AdminLoginForm() {
  ...
  if (confirmationSent) {
    return (
      <div className="mx-auto mt-10 max-w-sm rounded-2xl border border-white/10 bg-[#0b1a2b] p-6 text-center shadow-2xl shadow-black/50">
  ...
  return (
    <form
      className="mx-auto mt-10 grid max-w-sm gap-3 rounded-2xl border border-white/10 bg-[#0b1a2b] p-6 shadow-2xl shadow-black/50"
