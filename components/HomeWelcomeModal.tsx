    ...
    >
      ...
      >
        <div className="mb-5 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h2 id="home-welcome-title" className="text-lg font-black text-zinc-900">
        ...
        {user ? (
          ...
          <div className="mt-5 grid gap-3">
            ...
            <button
              type="button"
              onClick={dismiss}
              className="text-center text-xs font-bold uppercase tracking-wide text-zinc-500 transition hover:text-zinc-700"
            >
