...
export function RecentlyAddedCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg border border-white/10 bg-[#102032] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition hover:border-amber-400/50">
      <WantedButton
        isWanted={isWanted}
      ...
      <Link
        ...
        className="flex flex-col focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
      >
