...
export function ShelfPreviewClient() {
  ...
  if (!user) {
    return (
      ...
      >
        <h1 className="text-lg font-black text-zinc-900">Sign in to preview your shelf</h1>
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col">
      ...
      <div className="sticky top-0 z-10 border-b border-black/10 bg-white/85 backdrop-blur">
